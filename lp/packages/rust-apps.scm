    ...
    (arguments
     `(#:tests? #f ; no tests
       ...
       #:cargo-inputs (("rust-dialoguer" ,rust-dialoguer-0.10)
                       ...
                       ("rust-suggest" ,rust-suggest-0.4.0)
                       ("rust-thiserror" ,rust-thiserror-1)
                       ("rust-zellij-client" ,rust-zellij-client-0.40.1)
                       ("rust-zellij-server" ,rust-zellij-server-0.40.1)
                       ("rust-zellij-utils" ,rust-zellij-utils-0.40.1))
       #:cargo-development-inputs (("rust-insta" ,rust-insta-1.6.0)
