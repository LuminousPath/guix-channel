  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0rr54mvcfcv9cv6vw2122y28xvd2pwqpv2x8c8j5ayz3gwsy4rjw"))))
                  ...
                  (add-before 'build 'patch-setup-py
                    (lambda _
                      (substitute* "setup.py"
                        ...
                        (("(keyring>=21.2.0),<22.0.0" _ keyring)
                         keyring)
                        (("(packaging>=20.4),<21.0" _ packaging)
                         packaging))))
                  (delete 'sanity-check))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        ;might need to re-add a v1.11 patch for the fish shell
        (base32 "1rp4m3cvafr0yb09k4s22vvrphj4ysjhq43lx9d1gcjvqd229744"))))
    (build-system python-build-system)
    (arguments
     ;; tests rely on some older functionality for packages that I don't want
     ;; to recreate the old versions for.
     `(#:tests? #f))))
...
(define-public python-decli
  (package
    ...
    (build-system python-build-system)
    (home-page "https://github.com/woile/decli")
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0ascg98p2r7ay2n09gjd8q5d1z9znrwskyagg952mfli0bwkzw9y"))))
    (build-system python-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1gbi4sq3m6a5ja22bvfx6sndg2wxck88lwz1xqwf9y4r38zz8iir"))))
    (build-system python-build-system)
...
(define-public python-questionary
  (package
    ...
    (arguments
     (list
      #:tests? #f)) ;The tests require an internet connection
    (propagated-inputs (list python-prompt-toolkit python-pyyaml python-jinja2))
