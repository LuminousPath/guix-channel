...
;;      (origin
;;        (method url-fetch)
;;        (uri (string-append "https://github.com/hashicorp/vagrant/archive/" "v"
;;                            version ".tar.gz"))
;;        (file-name (string-append name "-" version ".tar.gz"))
;;        (sha256
;;         (base32 "0fbickjjliaw3cpkh3pl9bp56b2gcqn87c5ag67amc450ah43rdq"))))
;;     (build-system ruby-build-system)
;;     (arguments
;;      `(#:ruby ,ruby-2.6
;;        #:tests? #f)) ;bundler error.
;;     (propagated-inputs `(("ruby-childprocess" ,ruby-childprocess)
...
;;     (synopsis "Tool for building and distributing development environments")
