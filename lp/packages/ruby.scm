  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0viqszpkggqi8hq87pqp0xykhvz60g99nwmkwsb0v45kc2liwxvk"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;FIXME: Re-enable
    (native-inputs `(("ruby-rspec" ,ruby-rspec)))
    (propagated-inputs `(("ruby-public-suffix" ,ruby-public-suffix)))
    (synopsis
     "Replacement for the URI implementation of Ruby's standard library")
    (description
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0cj4k13c7qvvck7y25i3xarvyqq8d27vl61jddifkc7llnnap1hv"))))
    (build-system ruby-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0abb0fvgw00akyik1zxnq7yv391va148151qxdghnzngv66bl62k"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;No Rakefile ??
    (propagated-inputs `(("ruby-safe-yaml" ,ruby-safe-yaml)))
    (synopsis
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1f5kr8za7hvla38fc0n9jiv55iq62k5bzclsa5kdb14l3r4w6qnw"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (synopsis
     "Ruby binding to the Ed25519 elliptic curve public-key signature sys")
    (description
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0rn7lxdk3sqc2i4v2c5k25b9ca1qnkdf32nv04y760aml9mszwf7"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1qdfhj12aq8v0y961v4xv96a1y2z80h3xhvzrs9vsfgf884g6765"))))
    (build-system ruby-build-system)
...
the common features used for GSSAPI.")
    (home-page "https://github.com/zenchild/gssapi")
    (license license:expat)))
...
(define-public ruby-gyoku
  (package
    ...
    (license license:expat)))
; FIXME what's the license? BSD-something.
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0yj5l2rw8i8jc725hbcpc4wks0qlaaimr3dpaqamfjkjkxl0hjp9"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0skjkfm7ppnzxdh54fdzsbl5w3q5z42ha11kwrxrzszbq1xr7ik4"))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1z6mwzvd7p2wqhmk07dwrhvm0ncgqm7pxn0pr2k025rwsspp9bsd"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (native-inputs `(("ruby-rspec" ,ruby-rspec)
...
(define-public ruby-hoe-mercurial
  (package
    ...
    (synopsis
     "Fork of the hoe-hg plugin with extra features")
    (description "Hoe-mercurial, fork of the
@url{https://bitbucket.org/mml/hoe-hg,hoe-hg} plugin.")
    (home-page "https://www.rubydoc.info/gems/hoe-mercurial/1.4.1")
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1hqmkfa9f2xb5jlvqbafdxjd5ax75jm8gqj5nh3k22xq0kacsvgg"))))
    (build-system ruby-build-system)
    (arguments
     (list
      #:ruby ruby-2.7
          ...
          (add-after 'unpack 'fix-files-in-gemspec
            (lambda _
              (substitute* "listen.gemspec"
                (("`git ls-files -z`")
                 "`find . -type f -printf '%P\\\\0' |sort -z`")) #t))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1frilv82dyxnlg8k1jhrvyd73l6k17mxc5vwxx080r4x1p04gwym"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (synopsis
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1zflchpx4g8c110gjdcs540bk5a336nq6nmx379rdg56xw0pjd02"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (propagated-inputs (list ruby-little-plugger ruby-multi-json))
    (synopsis
     "Flexible logging library for use in Ruby programs")
    (description
     "Logging is a flexible logging library for use in Ruby programs based on the
design of Java's log4j library.  It features a hierarchical logging system,
custom level names, multiple output destinations per log event, custom
formatting, and more.")
    (home-page "https://rubygems.org/gems/logging")
    (license license:expat)))
...
(define-public ruby-net-scp-1.2.0
  (package
    ...
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (native-inputs (list bundler ruby-test-unit ruby-mocha))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1nsymscb30srnpxa5ml84my9gnfkn8x5hrzad2s0wdvi81j0z3yi"))))
    (build-system ruby-build-system)
    (propagated-inputs (list ruby-net-ssh))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "101wd2px9lady54aqmkibvy4j62zk32w0rjz4vnigyg974fsga40"))))
    (build-system ruby-build-system)
    (native-inputs (list bundler ruby-mocha ruby-test-unit))
    (synopsis "Ruby implementation of the SSH2 client protocol")
    (description
     "@code{Net::SSH} is a pure-Ruby implementation of the SSH2
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1qsyv6q073n9yw8kh27sml0sisn1r89syhkfl3kc266rlj350pkd"))))
    (build-system ruby-build-system)
    ;; needs rubocop, git.
    (arguments
     `(#:tests? #f)) ;;TODO: Re-enable.
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1cvaqarr1m84mhc006g3l1vw7sa5qpkcw0138lsxlf769zdllsgp"))))
    (build-system ruby-build-system)
    (synopsis
     "Make-like program implemented in Ruby")
    (description
     "Rake is a Make-like program implemented in Ruby.  Tasks and dependencies
are specified in standard Ruby syntax.  Rake has the following features: *
...
(is that a tab or a space?) * Users can specify tasks with prerequisites. *
Rake supports rule patterns to synthesize implicit tasks.  * Flexible
FileLists that act like arrays but know about manipulating file names and
paths.  * Supports parallel execution of tasks.")
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1f2wimhq93a1zy2fbyj7iyh7hvzmzwn3pzhkwb3npy4mj1df83n3"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (propagated-inputs (list ruby-ffi))
    (synopsis "Ruby wrapper for BSD's kqueue, using FFI")
    (description
     "This package provides a Ruby wrapper for BSD's kqueue, using FFI")
    (home-page "https://github.com/mat813/rb-kqueue")
    (license license:expat)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "16g3mmih999f0b6vcz2c3qsc7ks5zy4lj1rzjh8hf6wk531nvc6s"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
  ...
  (package
    ...
    (source
     (origin
       ...
       (uri (rubygems-uri "ruby_dep" version))
       (sha256
        (base32 "0v0qznxz999lx4vs76mr590r90i0cm5m76wwvgis7sq4y21l308l"))))
    (build-system ruby-build-system)
    (arguments
     (list
      #:ruby ruby-2.7
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0b8hczk8hysv53ncsqzx4q6kma5gy5lqc7s5yx8h64x3vdb18cjv"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (synopsis
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0grps9197qyxakbpw02pda59v45lfgbgiyw48i0mq9f2bn9y6mrz"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1hly915584hyi9q9vgd968x2nsi5yag9jyf5kq60lwzi5scr7094"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (native-inputs `(("ruby-rspec" ,ruby-rspec)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "16jpnq4xa7gavm024wk1rgmkfb850g89rv56f26dkh0rdhbqiqvs"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1fb0fivhyzfq1pc7n5pr9f9vwfgdr5nvszn9q8wvm33kai4f3ddq"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (synopsis
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "03994dxs4xayvkxqp01dd1ivhg4xxx7z35f7cxw7y2mwj3xn24ib"))))
    (build-system ruby-build-system)
    (native-inputs `(("bundler" ,bundler)
                     ("ruby-rspec" ,ruby-rspec)))
    (propagated-inputs `(("ruby-addressable" ,ruby-addressable)
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0nxf6a47d1xf1nvi7rbfbzjyyjhz0iakrnrsr2hj6y24a381sd8i"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1lmlaii8qapn84wxdg5d82gbailracgk67d0qsnbdnffcg8kswzd"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    (propagated-inputs (list ruby-erubi ruby-winrm ruby-winrm-fs))
    (synopsis
     "Library for running commands via WinRM elevated through scheduled task")
    (description
     "Ruby library for running commands via WinRM as elevated through a
scheduled task")
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0gb91k6s1yjqw387x4w1nkpnxblq3pjdqckayl0qvz5n3ygdsb0d"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO: Re-enable.
    ...
    (description
     "Ruby library for file system operations via Windows Remote Management")
    (home-page "https://github.com/WinRb/winrm-fs")
    (license license:expat)))
