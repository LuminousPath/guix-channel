...
(define-public rust-addr2line-0.21
  (package
    ...
    (synopsis
     "Cross-platform symbolication library written in Rust, using @code{gimli}")
    (description
...
(define-public rust-capstone-sys-0.16
  (package
    ...
    (description
     "This package provides System bindings to the capstone disassembly
library.")
    (license license:expat)))
     ...
     `(#:skip-build? #t
       #:cargo-inputs (("rust-anyhow" ,rust-anyhow-1)
                       ...
                       ("rust-cranelift-codegen-meta"
                        ,rust-cranelift-codegen-meta-0.108)
                       ("rust-cranelift-codegen-shared"
                        ,rust-cranelift-codegen-shared-0.108)
...
(define-public rust-cranelift-codegen-meta-0.108
  (package
    ...
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-cranelift-codegen-shared"
                        ,rust-cranelift-codegen-shared-0.108))))
    (home-page "https://github.com/bytecodealliance/wasmtime")
    (synopsis "Metaprogram for cranelift-codegen code generator library")
    (description
     "This package provides Metaprogram for cranelift-codegen code generator
library.")
    (license (list license:asl2.0 license:expat))))
...
(define-public rust-cranelift-entity-0.108
  (package
    ...
    (description
     "This package provides Data structures using entity references as mapping
keys.")
    (license (list license:asl2.0 license:expat))))
...
(define-public rust-cranelift-isle-0.108
  (package
    ...
    (description
     "This package provides ISLE: Instruction Selection and Lowering
Expressions.  A domain-specific language for instruction selection in
Cranelift.")
    (license (list license:asl2.0 license:expat))))
...
(define-public rust-fxprof-processed-profile-0.6
  (package
    ...
    (description
     "This package provides Create profiles in the Firefox Profiler's processed
profile JSON format.")
...
(define-public rust-memfd-0.6
  (package
    ...
    (description
     "This package provides a pure-Rust library to work with Linux memfd and
sealing.")
    (license (list license:expat license:asl2.0))))
...
routines")
    (description
     "This package provides Portable Stack Manipulation: stack manipulation and
...
(define-public rust-wasmprinter-0.230
  (package
    ...
    (description
     "This package provides Rust converter from the @code{WebAssembly} binary
    ...
    (arguments
     `(#:cargo-inputs (("rust-addr2line" ,rust-addr2line-0.21)
                       ...
                       ("rust-fxprof-processed-profile"
                        ,rust-fxprof-processed-profile-0.6)
                       ("rust-gimli" ,rust-gimli-0.28)
                       ("rust-hashbrown" ,rust-hashbrown-0.14)
                       ("rust-indexmap" ,rust-indexmap-2)
                       ...
                       ("rust-wasmtime-component-macro"
                        ,rust-wasmtime-component-macro-21)
                       ("rust-wasmtime-component-util"
                        ,rust-wasmtime-component-util-21)
                       ...
                       ("rust-wasmtime-jit-icache-coherence"
                        ,rust-wasmtime-jit-icache-coherence-21)
                       ("rust-wasmtime-slab" ,rust-wasmtime-slab-21)
                       ("rust-wasmtime-versioned-export-macros"
                        ,rust-wasmtime-versioned-export-macros-21)
                       ("rust-wasmtime-versioned-export-macros"
                        ,rust-wasmtime-versioned-export-macros-21)
...
(define-public rust-wasmtime-component-util-21
  (package
    ...
    (description
     "This package provides Utility types and functions to support the component
model in Wasmtime.")
    (license (list license:asl2.0 license:expat))))
...
(define-public rust-wasmtime-slab-21
  (package
    ...
    (description
     "This package provides Uni-typed slab with a free list for use in
Wasmtime.")
    (license (list license:asl2.0 license:expat))))
...
(define-public rust-wasmtime-wit-bindgen-21
  (package
    ...
    (description
     "This package provides Internal `*.wit` support for the `wasmtime` crate's
macros.")
    (license (list license:asl2.0 license:expat))))
...
(define-public rust-wast-230
  (package
    ...
    (description
     "This package provides Customizable Rust parsers for the @code{WebAssembly}
Text formats WAT and WAST.")
    (license (list license:asl2.0 license:asl2.0 license:expat))))
...
(define-public rust-wat-1
  (package
    ...
    (description
     "This package provides Rust parser for the @code{WebAssembly} Text format,
WAT.")
    (license (list license:asl2.0 license:asl2.0 license:expat))))
...
(define-public rust-wit-parser-0.207
  (package
    ...
    (description
     "This package provides Tooling for parsing `*.wit` files and working with
their contents.")
    (license (list license:asl2.0 license:expat))))
